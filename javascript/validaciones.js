...
function mensaje() {
    ...
    // Incorporamos una promesas para que la respuesta que hemos personalizado se muestre en formato json
    .then(respuesta => respuesta.json())
    
    // Esta promesa reliza una comprobación en el archivo 'enviarCorreo.php' y muestra el mensaje correpondiente
    .then(respuesta => {
        if('exito') {
            Swal.fire({
                icon: 'success',
